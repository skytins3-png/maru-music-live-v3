# MARU MUSIC LIVE GAME V3.1.6

## V3.1.6 원클릭 BIGO 방송 준비
...
## GitHub 빌드
이 압축 안의 파일을 저장소 최상단에 올린 뒤 Actions에서 `Build MARU MUSIC LIVE V3.1.6 APK`를 실행합니다. 이전 패치와 섞지 말고 이 전체 파일을 기준으로 사용합니다.
...
## V3.1.6 저장소 잔여 파일 오류를 먼저 정리하는 방법
